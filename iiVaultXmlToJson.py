...
def transformYodaXmlDataToJson(callback, dictSchema, xmlData):
    ...
    for mainGroup in dictSchema['properties']:
        jsonDict[mainGroup] = {}

        for elementName in dictSchema['properties'][mainGroup]['properties']:
            elementInfo = dictSchema['properties'][mainGroup]['properties'][elementName]
		    ...
		    totalElementList = []
                        ...
                        if isinstance(dataItem, dict):  # hier de structuur uitvissen
                            ...
                            try:
                                ...
                                if elementInfo['items']['yoda:structure'] == 'subproperties':
                                                ...
                                                if compoundInfo['yoda:structure'] == 'compound':  # Dit kan ook nog weer multiple of single zijn!!
                                                    ...
                                                    for dataItem2 in dataList:
                                                        ...
                                                        for compoundElement in compoundInfo['properties']:
                                                            compoundDict[compoundElement] = dataItem2[
                                                                compoundElement]  # ['Properties'][subPropertyElement][compoundElement]
                                    ...
                                    # Add to element
                                    # if fieldIsMultiple:
                                    #    jsonDict[mainGroup][elementName] = [newData]
                                    # else:
                                    #    jsonDict[mainGroup][elementName] = newData
                    ...
                    jsonDict[mainGroup][elementName] = totalElementList
                    ...
                    try:
                        if elementInfo['yoda:structure'] == 'compound':  # Compound handling on highest level, i.e. not as part of subproperty structure
                            ...
                            if (len(compoundList)):
                                ...
                                #
                                jsonDict[mainGroup][elementName] = secondList  # compoundList   #@TODO uitwerken!!
                    except KeyError:
                        continue
                else:
                    try:
                        jsonDict[mainGroup][elementName] = data
                    except KeyError:
                        pass
