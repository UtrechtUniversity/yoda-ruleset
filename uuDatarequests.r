...
#
uuGetDatarequests(*limit, *offset, *result, *status, *statusInfo) {
        *status = "Success";
        *statusInfo = "";
        ...
        *conditions = list(uucondition("COLL_PARENT_NAME", "=", *path),
                           uucondition("DATA_NAME", "=", "datarequest.json"),
...
# \return List of descriptive information about a number of research proposals.
#
uuGetDatarequestsAdditionalFields(*limit, *offset, *attributeName, *result,
                                  *status, *statusInfo) {
        *status = "Success";
        *statusInfo = "";
