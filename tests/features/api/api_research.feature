...
Feature: Research API
    ...
    Scenario Outline: Research folder move
        ...
        Examples:
            ...
            | /tempZone/home/research-initial | api_test_move2     | api_test_move2's    |
    ...
    Scenario Outline: Research folder delete
        ...
        Examples:
            | collection                      | folder                    |
            | /tempZone/home/research-initial | api_test_folder_renamed's |
            | /tempZone/home/research-initial | api_test_copy             |
            | /tempZone/home/research-initial | api_test_copy2            |
            | /tempZone/home/research-initial | api_test_copy2's          |
            | /tempZone/home/research-initial | api_test_move             |
            | /tempZone/home/research-initial | api_test_move2's          |
            | /tempZone/home/research-initial | api_test_1234567890       |
            | /tempZone/home/research-initial | api_test_folder's         |
