...
@given(parsers.parse("the Yoda research folder add API is queried with {folder} and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research folder move API is queried with {folder}, {move}, and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research folder delete API is queried with {folder} and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research file copy API is queried with {file}, {copy}, {copy_collection} and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research file move API is queried with {file}, {move_collection} and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research file delete API is queried with {file} and {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research system metadata API is queried with {collection}"), target_fixture="api_response")
...
@given(parsers.parse("the Yoda research collection details API is queried with {collection}"), target_fixture="api_response")
...
@then(parsers.parse("folder {folder} exists in {collection}"))
