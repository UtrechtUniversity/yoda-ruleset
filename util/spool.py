...
def get_spool_data(process: str) -> object | None:
...
def put_spool_data(process: str, data_list: Iterable) -> None:
...
def has_spool_data(process: str) -> bool:
...
def num_spool_data(process: str) -> int:
...
def _get_spool_directory(process: str) -> str:
