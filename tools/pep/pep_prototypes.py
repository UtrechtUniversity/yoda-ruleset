...
# These are automatically generated from https://raw.githubusercontent.com/irods/irods_docs/refs/heads/main/dynamic_peps.json
...
@policy.make_pep()
def pep_resource_read_checksum_from_storage_device_pre(ctx, instance_name, _ctx, out, _checksum_scheme, _returned_checksum): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_database_check_auth_credentials_pre(ctx, instance_name, _ctx, out, _username, _zone, _password, _correct): return policy.succeed()
@policy.make_pep()
def pep_database_check_permission_to_modify_data_object_pre(ctx, instance_name, _ctx, out, _data_id): return policy.succeed()
@policy.make_pep()
def pep_database_data_object_finalize_pre(ctx, instance_name, _ctx, out, _json_input): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_database_get_delay_rule_info_pre(ctx, instance_name, _ctx, out, _rule_id, _info): return policy.succeed()
@policy.make_pep()
def pep_database_get_grid_configuration_value_pre(ctx, instance_name, _ctx, out, _namespace, _option_name, _option_value, _option_value_buffer_size): return policy.succeed()
@policy.make_pep()
def pep_database_set_grid_configuration_value_pre(ctx, instance_name, _ctx, out, _namespace, _option_name, _option_value): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_database_update_ticket_write_byte_count_pre(ctx, instance_name, _ctx, out, _data_id, _bytes_written): return policy.succeed()
@policy.make_pep()
def pep_database_start_operation_pre(ctx, instance_name, _props, out): return policy.succeed()
@policy.make_pep()
def pep_database_check_password_operation_pre(ctx, instance_name, _ctx, out, _json_input, _valid): return policy.succeed()
@policy.make_pep()
def pep_database_make_session_token_operation_pre(ctx, instance_name, _ctx, out, _json_input, _token): return policy.succeed()
@policy.make_pep()
def pep_database_check_session_token_operation_pre(ctx, instance_name, _ctx, out, _json_input, _valid): return policy.succeed()
@policy.make_pep()
def pep_database_remove_session_tokens_operation_pre(ctx, instance_name, _ctx, out, _json_input): return policy.succeed()
@policy.make_pep()
def pep_database_remove_password_operation_pre(ctx, instance_name, _ctx, out, _json_input): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_authenticate_pre(ctx, instance_name, _comm, _request, _response): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_check_auth_credentials_pre(ctx, instance_name, rs_comm, check_auth_creds_inp, correct): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_genquery2_pre(ctx, instance_name, rs_comm, genquery2Inp, genquery2Out): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_get_delay_rule_info_pre(ctx, instance_name, rs_comm, rule_id, json_output): return policy.succeed()
@policy.make_pep()
def pep_api_get_grid_configuration_value_pre(ctx, instance_name, rs_comm, input, output): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_get_resource_info_for_operation_pre(ctx, instance_name, rs_comm, data_obj_inp, json_resc_info): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_register_physical_path_pre(ctx, instance_name, rs_comm, data_obj_inp, json_bbuf): return policy.succeed()
@policy.make_pep()
def pep_api_replica_close_pre(ctx, instance_name, rs_comm, json_input): return policy.succeed()
@policy.make_pep()
def pep_api_replica_open_pre(ctx, instance_name, rs_comm, data_obj_inp, json_output): return policy.succeed()
@policy.make_pep()
def pep_api_replica_truncate_pre(ctx, instance_name, rs_comm, data_obj_inp, json_output): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_set_grid_configuration_value_pre(ctx, instance_name, rs_comm, input): return policy.succeed()
@policy.make_pep()
...
@policy.make_pep()
def pep_api_switch_user_pre(ctx, instance_name, rs_comm, switch_user_inp): return policy.succeed()
@policy.make_pep()
