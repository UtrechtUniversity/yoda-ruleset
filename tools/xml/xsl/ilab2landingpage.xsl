...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<div class="map-placeholder">
	   <div class="map-init" />
	   <input type="hidden" class="west"  value="{westBoundLongitude}" />
	   <input type="hidden" class="east"  value="{eastBoundLongitude}" />
	   <input type="hidden" class="south" value="{southBoundLatitude}" />
	   <input type="hidden" class="north" value="{northBoundLatitude}" />	
	</div>
    </xsl:template>
