...
# \brief uuids function to return all the user and group ids found in a list of uuacl's
...
# \brief uuAclEqual function to compare two uuacl's
...
# \brief uuAclToStrings   find the user name and access level belonging to an uuacl
...
# \brief uuAclListOfPath generate a list of uuacl's from a path
...
# \brief uuAclListOfColl generate a list of uuacl's of a collection
...
# \brief uuAclListOfDataObj generate a list of uuacl's of a data object
...
# \brief uuAclListSetDiff  generate a list consisting of the set difference (see set theory) between two lists of uuacl's.
