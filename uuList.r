...
# \brief inlist  Returns true if a value is found in a list. Useful for inside expressions. Only works when the list elements and the value have the same type
...
#\brief headinlist	Helper function for in list. Checks the head of the list for value. The list is iterated using mutual recursion.
