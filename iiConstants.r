...
IIVALIDLOCKS = list("protect", "freeze", "tovault");
...
APPROVED = "APPROVED"
REJECTED = "REJECTED"
COPYINVAULT = "COPYINVAULT"

# \constant IIFOLDERSTATES
IIFOLDERSTATES = list(UNPROTECTED, PROTECTED, SUBMITTED, APPROVED, REJECTED, COPYINVAULT, CHILD);
...
IIFOLDERTRANSITIONS = list((UNPROTECTED, PROTECTED),
			   ...
			   (APPROVED, COPYINVAULT),
			   (COPYINVAULT, UNPROTECTED));
